...
export async function fetchEnrichedProjectsByFaculty(
    ...
    const enrichedProjects = projectData.map((project) => {
        ...
        return {
            ...
            teamMembers,
            fileUrls,
            subjectName: project.college_subjects?.subjectName,
            sectionName: project.college_sections?.collegeSections,
            branchName: project.college_academic_year?.college_branch?.collegeBranchCode || project.college_academic_year?.college_branch?.collegeBranchType,
            yearName: project.college_academic_year?.collegeAcademicYear,
        };
    });
