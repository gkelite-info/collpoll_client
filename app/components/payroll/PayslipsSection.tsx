...
export function PayslipsSection({ userId }: PayslipsSectionProps) {
  ...
  return (
    <>
      ...
      <div className="relative overflow-y-auto max-h-[300px] min-h-[150px] custom-scrollbar pb-2 space-y-4 rounded-xl pr-1">
        {isFetchingSlips ? (
          <>
            <PaySlipShimmer />
            <PaySlipShimmer />
          ...
          paySlips.map((slip) => (
            <div
              key={slip.id}
              className="bg-white rounded-xl p-5 shadow-[0px_4px_20px_rgba(0,0,0,0.03)] border border-gray-50 hover:shadow-[0px_8px_30px_rgba(0,0,0,0.06)] transition-shadow duration-300 mr-1"
            >
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-5">
                ...
                <div className="flex flex-wrap items-center gap-4 text-[13px] font-bold">
                  ...
                  <button className="flex items-center text-[#333333] hover:text-[#43C17A] transition-colors cursor-pointer group">
                    Download
                    <svg
