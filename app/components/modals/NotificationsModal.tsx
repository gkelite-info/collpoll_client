...
export default function NotificationsModal({ isOpen, onClose }: Props) {
  ...
  return (
    <Portal>
      ...
      <div className="fixed right-10 md:bottom-10 md:right-10 lg:bottom-10 lg:right-10 z-[1000] top-12 md:top-15 lg:top-20 translate-x-6 w-[328px] lg:w-[400px] bg-white rounded-md border border-[#E5E7EB] shadow-xl overflow-hidden flex flex-col">
