      ...
      <AnimatePresence>
        {isOpen && (
          <Portal>
            ...
            <motion.div
              className="fixed top-12 lg:top-20 right-4 z-[1000] h-[450px] w-[335px] md:w-[380px] md:h-[600px] lg:w-[380px] lg:h-[600px] max-h-[85vh] bg-white rounded-md border border-[#E5E7EB] shadow-xl flex flex-col overflow-hidden"
