...
export default function ResetPassword() {
  ...
  return (
    <main className="min-h-screen bg-[#FAFBFC] p-6 max-md:p-0 max-md:bg-[#F4F5F6]">
        ...
        <div className="rounded-lg bg-white p-6 shadow-sm max-md:rounded-xl max-md:p-5">
          <label className="block mb-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border text-[#282828] border-gray-300 px-3 py-3 text-sm outline-none focus:border-[#43C17A] disabled:opacity-60"
          ...
          <div className="flex justify-center pt-4">
            <button
              ...
              disabled={isProcessing}
              className="bg-[#43C17A] hover:bg-[#3ba869] disabled:bg-[#a1e0bd] w-full sm:w-auto cursor-pointer justify-center text-white px-6 py-2.5 rounded-lg shadow font-semibold flex items-center gap-2 transition-colors"
            >
              {isProcessing && (
