...
export default function AnnouncementsCard({ announceCard }: AnnouncementsCardProps) {

    return (
        <div className="bg-white rounded-md flex flex-col mt-5 p-2 shadow-md h-[375px]">
                    ...
                    >
                        ...
                        <div className="h-full w-[78%] rounded-md flex flex-col">
                            ...
                            <div className="h-[30%] flex items-center justify-between px-1">
                                <p style={{ fontSize: 11, color: "#454545" }}>{card.professor}</p>
