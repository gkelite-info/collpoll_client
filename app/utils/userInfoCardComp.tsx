...
//     <>
//       <div className="flex justify-between items-center rounded-lg h-[170px] bg-[#DAEEE3]">
//         <div className="flex flex-col justify-start w-[60%] p-4 gap-5 bg-yellow-00 rounded-l-lg h-[100%]">
//           <div className="flex items-center gap-3">
...
//               Student Id -{" "}
//               <span className="text-[#282828] text-sm">{studentId}</span>
//             </p>
//           </div>
//           <div className="flex items-center gap-3">
