      ...
      >
        <div className="bg-[#43C17A26] px-4 py-2 flex items-center justify-between gap-3 border-b-2 border-dotted border-[#43C17A]">
          <div className="flex gap-2 items-center justify-center">
            ...
            <span className="text-[#11934A] font-medium text-base">
              {formattedTimeRange}
            </span>
          </div>
        ...
        <div className="p-4 flex-1 flex flex-col gap-3">
          ...
          <div className="space-y-3 text-sm text-gray-600">
            <div className="flex items-center gap-1">
              <span className="min-w-22 text-[#303030] font-normal text-sm">
                {t("Description :")}
              </span>
              <p className="truncate text-sm text-[#16284F]">
                {data.description}
              </p>
            </div>
            ...
            <div className="flex items-center justify-between mt-3">
              <div className="flex items-center gap-1">
                <span className="min-w-20.5 text-[#303030] font-normal text-base">
                  {t("Date :")}
                </span>
