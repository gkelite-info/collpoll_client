...
const initialData = [
    { studentName: "Priya Sharma", rollNo: "22CSE101", educationType: "B.Tech", branch: "CSE", year: "3rd Year", semester: "Sem 5", paid: 214000, pending: 0 },
    { studentName: "Rahul Mehta", rollNo: "22EEE099", educationType: "B.Tech", branch: "EEE", year: "3rd Year", semester: "Sem 5", paid: 214000, pending: 30000 },
    { studentName: "Neha Patel", rollNo: "22MECH051", educationType: "B.Tech", branch: "MECH", year: "2nd Year", semester: "Sem 4", paid: 0, pending: 55000 },
    { studentName: "Arjun Kumar", rollNo: "23CSE045", educationType: "B.Tech", branch: "CSE", year: "2nd Year", semester: "Sem 3", paid: 50000, pending: 0 },
    { studentName: "Sneha Reddy", rollNo: "21ECE078", educationType: "B.Tech", branch: "ECE", year: "4th Year", semester: "Sem 7", paid: 30000, pending: 35000 },
    { studentName: "Vikram Singh", rollNo: "22CIVIL032", educationType: "B.Tech", branch: "CIVIL", year: "3rd Year", semester: "Sem 5", paid: 58000, pending: 0 },
    { studentName: "Anjali Verma", rollNo: "23EEE012", educationType: "B.Tech", branch: "EEE", year: "2nd Year", semester: "Sem 4", paid: 25000, pending: 30000 },
    { studentName: "Karthik Nair", rollNo: "21CSE089", educationType: "B.Tech", branch: "CSE", year: "4th Year", semester: "Sem 8", paid: 70000, pending: 0 },
    { studentName: "Deepika Rao", rollNo: "22ECE056", educationType: "B.Tech", branch: "ECE", year: "3rd Year", semester: "Sem 6", paid: 0, pending: 60000 },
    { studentName: "Aditya Joshi", rollNo: "23MECH021", educationType: "B.Tech", branch: "MECH", year: "2nd Year", semester: "Sem 3", paid: 52000, pending: 0 },
];
...
export default function OverallStudentsOverview() {
    ...
    const filteredData = useMemo(() => {
        return initialData
            ...
            .filter((item) =>
                (educationFilter === "All" || item.educationType === educationFilter) &&
            ...
            .filter((item) => {
                ...
                if (statusFilter === "Pending") return item.pending > 0 && item.paid === 0;
                if (statusFilter === "Partial") return item.pending > 0 && item.paid > 0;
                return true;
            })
            .map((item) => ({
                ...item,
                ...
                status: (() => {
                    ...
                    return (
                        <div className="flex items-center justify-center gap-2">
                            <span
                                className={`h-2.5 w-2.5 rounded-full ${statusType === "Paid"
                                    ? "bg-green-500"
                                    : statusType === "Pending"
                                        ? "bg-red-500"
                                        : "bg-orange-500"
                            ...
                            />
                            <span
                                className={`text-sm font-medium ${statusType === "Paid"
                                    ? "text-green-600"
                                    : statusType === "Pending"
                                        ? "text-red-600"
                                        : "text-orange-600"
                ...
                action: (
                    <span
                        onClick={() =>
                            router.push(`/finance/students/${item.branch}`)
                        }
    ...
    }, [search, educationFilter, branchFilter, yearFilter, semesterFilter, statusFilter]);
        ...
        <div className="p-2 min-h-screen space-y-6">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-1">
                    <CaretLeftIcon size={20} className="cursor-pointer" onClick={() => router.back()} />
            ...
            <h1 className="text-lg text-[#282828] font-bold mb-3 -mt-3">Overall Students Overview</h1>
            <TableComponent columns={columns} tableData={filteredData} height="55vh" />
        </div>
    );
}
