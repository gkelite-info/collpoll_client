      ...
      <div className="custom-scrollbar relative max-h-[92vh] w-full max-w-[520px] overflow-y-auto rounded-md bg-white p-6 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="mt-4 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button type="submit" disabled={isSubmitting || !hasRequiredEmployeeLeaveTags(role, formData.tags)} className="h-11 cursor-pointer rounded bg-[#43C17A] text-sm font-semibold text-white hover:bg-[#34A565] disabled:cursor-not-allowed disabled:opacity-70">
