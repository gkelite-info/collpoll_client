...
export default function SubjectAttendanceDetails() {
    ...
    const cards: CardItem[] = [
        ...
        { id: 2, icon: <Chalkboard size={30} weight="fill" />, value: "28", label: "Attended", style: "bg-[#FFEDDA] w-[182px]", iconBgColor: "#FFBC72", iconColor: "#EFEFEF" },
        { id: 3, icon: <Chalkboard size={30} weight="fill" />, value: "1", label: "Leave", style: "bg-[#FFE6E6] w-[182px]", iconBgColor: "#F62D2D", iconColor: "#EFEFEF" },
        { id: 4, icon: <Percent size={30} weight="fill" />, value: "87%", label: "Attendance", style: "bg-[#CEE6FF] w-[182px]", iconBgColor: "#60AEFF", iconColor: "#EFEFEF" },
    ];
            ...
            <div className="mt-4 flex flex-col items-center">
                <div className="w-full flex flex-col items-start">
                    ...
                    {detailCard.map((item, index) => (
                        <div className="bg-blue-00 w-full mt-2 flex items-center" key={index}>
                            <div className="flex items-center gap-1">
                                ...
                                <div className="rounded-full px-3 h-[25px] flex items-center justify-center bg-[#DCEAE2]">
                                    <p className="text-sm text-[#43C17A] font-medium">{item.subject}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-1 ml-6">
                                <h5 className="text-[#525252] text-sm">Faculty :</h5>
                                <div className="rounded-full px-3 h-[25px] flex items-center justify-center bg-[#DCEAE2]">
                                    <p className="text-sm text-[#43C17A] font-medium">{item.faculty}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-1 ml-6">
                                <h5 className="text-[#525252] text-sm">Attendance :</h5>
                                <div className="rounded-full px-3 h-[25px] flex items-center justify-center bg-[#DCEAE2]">
                                    <p className="text-sm text-[#43C17A] font-medium">{item.attendance}</p>
                                </div>
                            </div>
                        </div>
                    ))}
