...
export type CollegeAdminLeaveStatus = "approved" | "pending" | "rejected";
...
export type CollegeAdminLeaveRequest = {
  ...
  description: string;
  attachment?: string;
  status: CollegeAdminLeaveStatus;
  chat: LeaveChatMessage[];
};

export const leaveRequests: CollegeAdminLeaveRequest[] = [
  {
    serialNo: "01",
