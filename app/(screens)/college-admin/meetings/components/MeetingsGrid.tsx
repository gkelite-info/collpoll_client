        ...
        {data.map((item, index) => (
          ...
          >
            <div className="bg-[#E6F4EC] px-5 py-4 flex items-center gap-3">
              ...
              <span className="text-[#11934A] text-base font-medium">
                {item.time}
              </span>
            </div>
            <div className="border-t-2 border-dashed border-[#43C17A]" />
            <div className="p-5">
              <h3 className="text-[#43C17A] text-lg font-semibold mb-4">
                {item.title}
              </h3>
              <div className="space-y-3 text-[#282828]">
                <div className="flex items-center gap-2">
                  <span className="font-regular">Education Type :</span>
                  <span className="bg-[#E3E7ED] text-[#1F2F56] px-3 py-1 rounded-full text-sm">
                    {item.educationType}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-regular">Admin :</span>
                  <span className="bg-[#E3E7ED] text-[#1F2F56] px-3 py-1 rounded-full text-sm">
                    {item.admin}
                  </span>
                </div>
