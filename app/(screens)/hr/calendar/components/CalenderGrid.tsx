...
const CalendarGrid: React.FC<CalendarGridProps> = ({
  ...
  const matchesFilter = (event: any): boolean => {
    if (activeTab === "All" || activeTab === "All Scheduled") return true;
        ...
        <div className="flex min-h-[720px]">
          ...
          <div className="flex-1 grid grid-cols-6 relative">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none flex flex-col">
              {TIME_SLOTS.map((_, i) => (
                <div key={i} className="h-[120px] border-b border-[#C6C6C69E]" />
              ))}
            </div>
            ...
            {weekDays.map((dayObj) => (
              <div
                key={dayObj.fullDate}
                className="relative border-r border-[#C6C6C69E] last:border-r-0"
              >
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        width: `${100 / (event.overlapTotal || 1)}%`,
                        left: `${(100 / (event.overlapTotal || 1)) * (event.overlapIndex || 0)}%`,
                      }}
