...
// const mockStaffData: StaffRecord[] = [
//   {
//     name: "Dr. Meera Sharma",
//     mobile: "+91 9046592034",
//     id: "ID-74849901",
//     role: "Faculty",
//     status: "Onboard",
//   },
...
//     switch (status) {
//       case "Onboard":
//         return "bg-[#43C17A] hover:bg-[#3ba869] text-white";
//       case "Onboarding":
//         return "bg-[#5DD38F] hover:bg-[#43C17A] text-white";
//       case "Onboarded":
//         return "bg-[#16284F] text-white cursor-default";
//       default:
...
//   return (
//     <div className="rounded-xl p-4 w-full h-full min-h-[80vh]">
//       <AddEmployeeModal
//         isOpen={isModalOpen}
...
//                     className={`px-4 py-1.5 cursor-pointer rounded font-bold text-[12px] min-w-[100px] text-center transition-colors ${getStatusStyle(row.status)}`}
//                   >
//                     {row.status}
//                   </button>
//                 </td>
