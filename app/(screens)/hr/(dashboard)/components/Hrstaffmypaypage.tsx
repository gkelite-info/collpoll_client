...
// import AddPayModal from "../../MyAttendance/components/AddPayModal";
...
// export default function HrStaffMyPayPage({ userId }: { userId: string }) {
...
//               <h2 className="text-[16px] font-extrabold text-[#333333]">My Salary</h2>
//               <button
...
//                     <p className="text-[#666666] text-[13px] font-medium mt-1">INR 50,000</p>
//                   </div>
//                   <div>
//                     <p className="text-[#333333] font-bold text-[13px]">Total CTC</p>
...
//             {[
//               { label: "Net Taxable Income", value: "INR 3,39,200" },
//               { label: "Gross Income Tax", value: "INR 3,39,200" },
//               { label: "Total Surcharge & Cess", value: "INR 3,39,200" },
//               { label: "Net Income Tax Payable", value: "INR 3,39,200" },
//               { label: "TAX paid Till Now", value: "INR 0" },
//               { label: "Remaining Tax To Be Paid", value: "INR 0" },
//             ].map((item) => (
//               <div key={item.label}>
//                 <p className="text-[#333333] font-bold text-[14px]">{item.label}</p>
//                 <p className="text-[#43C17A] font-medium text-[13px] mt-1">{item.value}</p>
//               </div>
//             ))}
//           </div>
