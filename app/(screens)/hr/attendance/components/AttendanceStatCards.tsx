  ...
  const cards = [
    {
      ...
      colors: { activeBg: "bg-[#6C20CA]", inactiveBg: "bg-[#E2DAFF]", iconHex: "#6C20CA" },
    },
    {
      id: "present",
      label: "Present Today",
      ...
      colors: { activeBg: "bg-[#43C17A]", inactiveBg: "bg-[#E6FBEA]", iconHex: "#43C17A" },
    },
    {
      id: "absent",
      label: "Absent Today",
      value: absentCount,
      icon: <User size={22} weight="fill" />,
      colors: { activeBg: "bg-[#FF0000]", inactiveBg: "bg-[#FFE0E0]", iconHex: "#FF0000" },
    },
    {
      id: "late",
      ...
      colors: { activeBg: "bg-[#60AEFF]", inactiveBg: "bg-[#CEE6FF]", iconHex: "#60AEFF" },
    },
    {
      id: "leave",
      label: "On Leave",
      value: leaveCount,
      icon: <User size={22} weight="fill" />,
      colors: { activeBg: "bg-[#FFBE61]", inactiveBg: "bg-[#FFEDDA]", iconHex: "#FFBE61" },
    },
  ];
