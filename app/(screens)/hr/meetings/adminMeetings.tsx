...
const MOCK_MEETINGS: Meeting[] = [
    ...
    { id: 'u4', financeMeetingId: 104, financeMeetingSectionsId: 4, category: 'Admin', title: 'Scholarship Grant Approvals', timeRange: '04:00  - 05:00 ', educationType: 'B.Tech', branch: 'ECE', description: 'Finalizing the list of students for merit scholarships.', date: '05 Apr 2026', participants: 20, year: '2026', section: 'C', tags: 'Grants, Students', type: 'upcoming', meetingLink: 'https://meet.google.com/asd-fghj-klz' },
    ...
    { id: 'p4', financeMeetingId: 204, financeMeetingSectionsId: 10, category: 'Admin', title: 'Emergency Software Licensing', timeRange: '04:00 - 04:45', educationType: 'B.Tech', branch: 'CSE', description: 'Approval for urgent renewal of IDE licenses.', date: '25 Feb 2026', participants: 5, year: '2026', section: 'B', tags: 'Software, IT', type: 'previous', meetingLink: 'https://meet.google.com/prev-abc' },
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pb-10">
                            {isLoading ? (
                                ...
                                meetings.map((meeting) => (
                                    <MeetingCard key={meeting.id} data={meeting} role={"Finance"} />
                                ))
                            ) : (
