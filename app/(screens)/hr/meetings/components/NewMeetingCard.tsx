...
const DetailPill = ({ label }: { label: string | number }) => (
    <span className="bg-[#EEF2F6] text-[#16284F] px-4 py-1.5 rounded-full text-sm font-medium whitespace-nowrap">
        {label}
    </span>
);
    ...
    return (
        <>
            <div
                ...
                className="bg-[#F8FDF9] rounded-xl shadow-sm border border-gray-200 overflow-hidden flex flex-col h-full hover:shadow-md transition-shadow cursor-pointer"
            >
                <div className="bg-[#43C17A26] px-4 py-3 flex items-center justify-between gap-3 border-b-[2px] border-dashed border-[#43C17A]">
                ...
                <div className="p-4 flex-1 flex flex-col gap-4">
                    <div className="flex justify-between items-start gap-2">
                        <h2 className="text-[#43C17A] font-semibold text-lg leading-tight truncate">
                            {data.title}
                        </h2>
                        {data.branch && (
                    ...
                    <div className="flex items-start gap-2">
                        <span className="text-[#414141] font-normal text-sm whitespace-nowrap">Description :</span>
                    ...
                    <div className="flex items-center gap-2">
                        <span className="text-[#414141] font-normal text-sm whitespace-nowrap">Date :</span>
                    ...
                    <div className="flex items-center justify-between mt-auto pt-2">
                        <div className="flex items-center">
                            ...
                            <span className="text-sm text-[#414141] ml-3 font-medium">
                                + {data.participants} Faculties
                            </span>
                        </div>

                        <button
                            className={`px-5 py-2 rounded-full text-sm font-semibold transition-colors ${data.type === 'previous'
                ...
                {isModalOpen && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden p-6 relative"
                        >
