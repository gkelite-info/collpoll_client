...
export default function SelectFacultyModal({
  ...
  useEffect(() => {
    const loadUsers = async () => {
      ...
      try {
        const data = await getCollegeUsers(
          roleName,
          collegeId,
          educationTypeId,
  ...
  const isAllSelected =
    ...
    filteredFaculty.every((f) => selectedIds.includes(f.userId));
        ...
        >
          ...
          >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">{f.subLabel}</p>
                        </div>
                      </div>
            ...
            <div className="mt-4 flex gap-3">
              <button
                onClick={onClose}
                className="flex-1 py-1.5 bg-gray-200 rounded-md text-black cursor-pointer hover:bg-gray-300 transition-colors"
              >
                Cancel
              </button>
