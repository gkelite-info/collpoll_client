...
import { Loader } from '@/app/(screens)/(student)/calendar/right/timetable';
 ...
 function MyPayPage() {
  ...
  const paySlips = [
    { id: 1, month: "January 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
    { id: 2, month: "February 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
    { id: 3, month: "March 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
    { id: 4, month: "January 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
    { id: 5, month: "February 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
    { id: 6, month: "March 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
    { id: 7, month: "January 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
    { id: 8, month: "February 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
    { id: 9, month: "March 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
    { id: 11, month: "January 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
    { id: 12, month: "February 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
    { id: 13, month: "March 2025", date: "23/09/2025", gross: "45,500.0", deductions: "5,80.00", net: "6,90.00" },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="col-span-1 flex flex-col gap-4">
                ...
                <div className="bg-white rounded-xl p-4 shadow-[0px_4px_20px_rgba(0,0,0,0.03)] border border-gray-50 flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-[#333333] font-semibold text-[14px] mt-0.5">Paycycle</p>
                  </div>
                  <span className="text-[#43C17A] font-bold text-[14px] mt-4">Monthly</span>
                </div>
              </div>
              ...
              <div className="col-span-1 md:col-span-2 bg-white rounded-xl p-5 shadow-[0px_4px_20px_rgba(0,0,0,0.03)] border border-gray-50 flex flex-col justify-between">
                ...
                <div className="grid grid-cols-4 gap-2 mt-5">
                  ...
                  <div>
                    <p className="text-[#333333] font-bold text-[13px]">Bonus</p>
                    <p className="text-[#666666] text-[13px] font-medium mt-1">INR 50,00,000</p>
                  </div>
                  <div>
                    <p className="text-[#333333] font-bold text-[13px]">Total</p>
                    <p className="text-[#666666] text-[13px] font-medium mt-1">INR 9,00,005</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {paySlips.map((slip) => (
              <div key={slip.id} className="bg-white rounded-xl p-5 shadow-[0px_4px_20px_rgba(0,0,0,0.03)] border border-gray-50">
                <div className="flex justify-between items-center mb-5">
                  <h3 className="text-[15px] font-bold text-[#333333]">{slip.month}</h3>
                  <div className="flex items-center space-x-4 text-[13px] font-bold">
                    <span className="text-[#333333]">Status - <span className="text-[#43C17A]">Paid</span></span>
                    <button className="flex items-center text-[#333333] hover:text-[#43C17A] transition-colors">
                      Download
                      <svg className="w-[14px] h-[14px] ml-1.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-8 text-[13px]">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-[#666666] font-medium">{slip.deductions}</span>
                  </div>
                  <div className="flex items-center">
                    <span className="w-[100px] font-bold text-[#333333]">Gross Pay :</span>
                    <span className="text-[#666666] font-medium">{slip.gross}</span>
                  </div>
                  <div className="flex items-center">
                    <span className="w-[100px] font-bold text-[#333333]">Net Pay :</span>
                    <span className="text-[#666666] font-medium">{slip.net}</span>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="flex-1 min-h-[154vh] overflow-y-auto pr-2 pb-6 custom-scrollbar">
          <div className="bg-white rounded-xl p-6 shadow-[0px_4px_20px_rgba(0,0,0,0.03)] border border-gray-50 mb-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-6 gap-x-4">
            <div>
              ...
              <p className="text-[#43C17A] font-medium text-[13px] mt-1">INR 3,39,200</p>
            </div>
            <div>
              <p className="text-[#333333] font-bold text-[14px]">Gross Income Tax</p>
              <p className="text-[#43C17A] font-medium text-[13px] mt-1">INR 3,39,200</p>
            </div>
            <div>
              <p className="text-[#333333] font-bold text-[14px]">Total Surcharge & Cess</p>
              <p className="text-[#43C17A] font-medium text-[13px] mt-1">INR 3,39,200</p>
            </div>
            <div>
              <p className="text-[#333333] font-bold text-[14px]">Net Income Tax Payable</p>
              <p className="text-[#43C17A] font-medium text-[13px] mt-1">INR 3,39,200</p>
            </div>
            <div>
              <p className="text-[#333333] font-bold text-[14px]">TAX paid Till Now</p>
              <p className="text-[#43C17A] font-medium text-[13px] mt-1">INR 0</p>
            </div>
            <div>
              <p className="text-[#333333] font-bold text-[14px]">Remaining Tax To Be Paid</p>
              <p className="text-[#43C17A] font-medium text-[13px] mt-1">INR 0</p>
            </div>
          </div>
