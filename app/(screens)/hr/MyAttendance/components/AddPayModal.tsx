...
//       ...formData,
//       addons: addons.map(({ isOpen, ...rest }) => rest),
//     };
//     console.log("Ready to send to Supabase:", payload);
//     onClose();
//   };
...
//                       onChange={handleInputChange}
//                       placeholder="00"
//                       className="border border-gray-300 rounded px-2 py-1.5 text-[14px] font-bold text-[#282828] placeholder:font-normal placeholder:text-gray-400 text-center focus:outline-none focus:border-[#43C17A]"
//                     />
//                   </div>
//                 ))}
//               </div>
...
//                         {/* Better UX: "Configure" when open, actual name when closed */}
//                         {addon.isOpen ? (
...
//                   className="flex items-center cursor-pointer justify-center gap-2 mt-1 py-2.5 border-2 border-dashed border-[#43C17A] text-[#43C17A] rounded-lg font-bold text-[13px] hover:bg-[#43C17A]/5 transition-colors"
//                 >
//                   <svg
//                     className="w-4 h-4"
//                     viewBox="0 0 24 24"
...
//           <button
//             onClick={onClose}
//             className="flex-1 bg-[#F5F5F5] cursor-pointer hover:bg-[#E8E8E8] text-[#555] py-2.5 rounded-lg font-bold text-[14px] transition-colors"
//           >
//             Cancel
//           </button>
//           <button
//             onClick={handleSave}
//             className="flex-1 bg-[#43C17A] cursor-pointer hover:bg-[#3ba869] text-white py-2.5 rounded-lg font-bold text-[14px] shadow-md shadow-[#43C17A]/20 transition-all"
//           >
//             Save Details
//           </button>
//         </div>
