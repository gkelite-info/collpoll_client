  ...
  return (
    <main className="flex h-screen flex-col overflow-hidden p-2 bg-red-00 max-md:p-0 max-md:bg-[#F4F5F6]">
      {pageLoading ? (
        ...
        <section className="mb-4 flex shrink-0 items-center justify-between max-md:px-4 max-md:pt-4 max-md:mb-2">
          <div>
            <h1 className="text-black text-2xl font-semibold max-md:text-[22px]">
              Placements
            </h1>
            <p className="text-black text-sm max-md:hidden">
                  ...
                  <button
                    ...
                    className={
                      activeTab === "opportunities"
                        ...
                        : "text-[#4B4B4B] cursor-pointer font-medium hover:text-black transition"
                    }
                  >
                    Opportunities /
                  </button>
