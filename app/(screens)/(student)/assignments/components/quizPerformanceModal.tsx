...
//                     <div className="relative w-48 h-48 lg:mt-4 flex items-center justify-center">
...
//                             <span className="text-3xl font-extrabold font-black bg-gradient-to-b from-[#DDCC18] to-[#713F06] bg-clip-text text-transparent tracking-tight">{quiz.score}</span>
...
//                         <p className="text-sm text-gray-600 mt-1">you answered {quiz.percentage}% of question correctly.</p>
//                     </div>
...
//                         </div>
//                     </div>
//                     <div className="w-[100%] bg-red-00 lg:mt-5 flex items-center justify-center">
//                         <button className="bg-[#16284F] lg:px-3.5 lg:py-1.5 rounded-md cursor-pointer text-white font-medium"
//                             onClick={handleClose}
//                         >
//                             Close
//                         </button>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-[90vw] max-h-[90vh] overflow-y-auto flex flex-col">
        ...
        <div className="p-6 flex flex-col items-center relative">
          ...
          <div className="relative w-48 h-48 lg:mt-4 flex items-center justify-center">
            <img src="result-circle.png" alt="result-circle" />

            <div className="absolute flex flex-col items-center justify-center">
              <span className="text-3xl font-extrabold font-black bg-gradient-to-b from-[#DDCC18] to-[#713F06] bg-clip-text text-transparent tracking-tight">
                {quiz.score}
              </span>
              <span className="text-sm font-bold text-[#16284F]">
                {quiz.percentage}%
              </span>
          ...
          <div className="w-[100%] bg-red-00 lg:mt-5 flex items-center justify-center">
            <button
              className="bg-[#16284F] lg:px-3.5 lg:py-1.5 rounded-md cursor-pointer text-white font-medium"
              onClick={handleClose}
            >
              {t("Close")}
            </button>
