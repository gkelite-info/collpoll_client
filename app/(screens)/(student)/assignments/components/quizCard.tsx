                ...
                <div className="flex flex-col justify-between h-full w-full">
                    <div className="flex items-center justify-between">
                        <div className="flex flex-col gap-1">
                            <h3 className="text-lg font-bold text-[#282828]">{data.courseName}</h3>
                            <p className="text-[#282828] font-medium text-sm mb-4">{data.topic}</p>
                        </div>
                        <div className="flex flex-col h-full justify-start items-end self-start">
                            <button onClick={handleStartQuiz} className="bg-[#43C17A] text-white px-5 py-2 rounded-md cursor-pointer text-sm font-semibold">
                                Start Quiz
                            </button>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-x-8 gap-y-2.5">
                        <div className="flex items-center gap-2 text-xs text-[#282828]">
                            <div className="bg-[#43C07A24] rounded-full p-1">
                                <UserCircle size={16} className="text-[#43C17A]" weight="regular" />
                            </div>
                            <span className="font-semibold text-[#282828] text-sm">Faculty Name :</span> <span className="text-[#282828]">{data.facultyName}</span>
                        </div>
                        <div className="flex items-center gap-2 text-xs text-[#282828]">
                            <div className="bg-[#43C07A24] rounded-full p-1">
                                <RepeatIcon size={16} className="text-[#43C17A]" weight="regular" />
                            </div>
                            <span className="font-semibold text-sm text-[#282828]">Attempts Left :</span> <span className="text-[#282828]">{data.attemptsLeft}</span>
                        </div>
                        <div className="flex items-center gap-2 text-xs text-[#282828]">
                            <div className="bg-[#43C07A24] rounded-full p-1">
                ...
                <div className="flex flex-col justify-between h-full w-full">
                    ...
                    <div className="grid grid-cols-2 gap-x-8 gap-y-2.5">
                        ...
                        <div className="flex items-center gap-2 text-xs text-[#282828]">
                            ...
                            <span className="font-semibold text-sm text-[#282828]">Attempted On :</span> <span className="text-[#282828]">{data.attemptedOn}</span>
                        </div>
                        <div className="flex items-center gap-2 text-xs text-[#282828]">
                            <div className="bg-[#43C07A24] rounded-full p-1">
                                <Question size={16} className="text-[#43C17A]" weight="regular" />
                            </div>
                            <span className="font-semibold text-sm text-[#282828]">Questions Attempted :</span> <span className="text-[#282828]">{data.questionsAttempted}</span>
                        </div>
                        <div className="flex items-center gap-2 text-xs text-[#282828]">
                            <div className="bg-[#43C07A24] rounded-full p-1">
                                <RepeatIcon size={16} className="text-[#43C17A]" weight="regular" />
                            </div>
                            <span className="font-semibold text-sm text-[#282828]">Attempts Used :</span> <span className="text-[#282828]">{data.attemptsUsed}</span>
                        </div>
                    </div>
                </div>
            </div>
