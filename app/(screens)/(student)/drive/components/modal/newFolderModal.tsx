      ...
      <div className="w-full max-w-md rounded-lg bg-white p-5 shadow-xl">
        ...
        <div className="flex gap-3">
          <button
            ...
            onClick={handleSave}
            disabled={loading}
            className="flex-1 rounded bg-[#43C17A] py-2 text-sm font-semibold text-white disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
          ...
          <button
            ...
            onClick={onCancel}
            disabled={loading}
            className="flex-1 rounded border border-[#D1D5DB] py-2 text-sm font-semibold text-[#111827] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
        </div>
