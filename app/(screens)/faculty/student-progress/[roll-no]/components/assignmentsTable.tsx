...
import { getFacultyStudentTasks } from "@/lib/helpers/faculty/studentProgress/getFacultyStudentTasks";
import type { FacultyStudentProgressDetailsScope } from "@/lib/helpers/faculty/studentProgress/sharedProgressTypes";
import { AssignmentsTableSkeleton as AcademicTasksSkeleton } from "../../shimmer/StudentProgressSkeleton";
...
export default function AssignmentsTable({
  ...
  const {
    ...
    queryKey: ["facultyStudentTasks", scope, activeTab],
    queryFn: ({ pageParam = 0 }) =>
      getFacultyStudentTasks({
        ...scope,
        taskType: activeTab,
        pageParam,
      }),
