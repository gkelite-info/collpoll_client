...
export function UnitCardSkeleton() {
  return (
    <div className="min-w-[85vw] w-[85vw] md:min-w-[320px] md:w-[350px] shrink-0 snap-start max-md:min-w-0 max-md:w-full max-md:h-auto">
...
export const TopicSkeleton = () => (
  <li className="flex items-center justify-between gap-2 py-1.5 animate-pulse mb-1">
    <div className="flex items-center gap-2 w-full">
      <div className="w-4 h-4 rounded-full bg-gray-200 shrink-0"></div>
      <div className="h-3.5 bg-gray-200 rounded w-3/4 max-w-[180px]"></div>
    </div>
