...
interface Props {
    userRole: string; // "mentor" or "responsiblefaculty"
    clubId: number;
    collegeId: number;
    facultyId: number;
...
export default function Announcements({ userRole, clubId, collegeId, facultyId, onDateChange }: Props) {
    ...
    const fetchOlderMessages = async () => {
        ...
        try {
            ...
            toast.error("Failed to load older messages", { id: "pg-err-fac" });
        } finally {
            ...
            >
                ...
                <div className="flex flex-col gap-4 pb-2 min-h-full justify-end">
                    ...
                    {messages.map((announcement) => {
                        ...
                        // CHANGED: Checking against authorFacultyId instead of studentId
                        const isMyMessage = announcement.authorFacultyId === facultyId;
