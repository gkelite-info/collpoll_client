...
export default function Announcements() {
    ...
    const handleSend = (e: React.FormEvent) => {
        ...
        const newMessage: Announcement = {
            ...
            // Assign a random avatar for the new message to match the design
    ...
    return (
        <div className="mx-auto mt-6 flex h-[750px] w-full max-w-2xl flex-col bg-transparent">
                ...
                <div className="flex items-center gap-4">
                    <div className="relative flex-1">
                        <input
                            ...
                            className="w-full rounded-full bg-[#E5E5E5] py-3.5 pl-6 pr-14 text-sm font-medium text-[#282828] placeholder-[#6F6F6F] outline-none transition-all focus:ring-2 focus:ring-[#1e2b4d]"
                        />
                        <button
                            type="submit"
                            disabled={!inputValue.trim()}
                            className="absolute right-2 top-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center rounded-full bg-[#16284F] text-white shadow-sm transition-colors hover:bg-gray-800 disabled:opacity-70 disabled:hover:bg-[#1e2b4d]"
                        >
                            <PaperPlaneRightIcon size={25} weight="fill"/>
                        </button>
                    </div>
