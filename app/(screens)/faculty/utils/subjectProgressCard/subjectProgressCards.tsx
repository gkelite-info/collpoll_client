...
export default function SubjectProgressCards({
  ...
  return (
    <>
      <div className="bg-white h-64 rounded-lg w-full p-4 shadow-md flex flex-col gap-2">
        <div className="flex justify-between items-center">
          <h6 className="text-[#282828] font-semibold max-md:text-[16px]">
            {t("Subjects Progress")}
          </h6>
          <FaChevronRight
        ...
        <div className="flex flex-col gap-2 overflow-y-auto">
          {isLoading ? (
            ...
            props.map((subject, index) => (
              ...
              >
                <div className="h-full w-[22%] max-md:w-[20%] rounded-md flex items-center justify-center overflow-hidden">
                  {subject.image ? (
                    <img
                      src={subject.image}
                      alt={subject.title}
