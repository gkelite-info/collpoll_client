...
export default function SubjectProgressCards({ props, onViewMore, isLoading }: SubjectProgressCardProps) {
    return (
        <>
            <div className="bg-white h-64 rounded-lg w-[49%] p-4 shadow-md flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2 overflow-y-auto">
                    {isLoading ? (
                        [1, 2, 3].map((_, i) => (
                            <div key={i} className="h-20 flex items-center rounded-lg p-2 gap-1 bg-gray-50 animate-pulse">
