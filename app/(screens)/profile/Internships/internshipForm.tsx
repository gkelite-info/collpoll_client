...
// import { InternshipInsert } from "@/app/api/supabase/types";
// import { createInternshipAction } from "@/app/actions/internship.actions";
...
//     try {
//       const payload: InternshipInsert = {
...
//       await createInternshipAction(payload);
...
export default function InternshipForm({
  ...
  studentId: number;
  onSubmitted: (data: InternshipFormData) => void;
}) {
  const {
    register,
    handleSubmit,
  ...
  const onSubmit: SubmitHandler<FormValues> = async (data) => {
    try {
      ...
      onSubmitted(data as InternshipFormData);
    } catch (error) {
      console.error(error);
      toast.error("Failed to save internship");
    }
