...
export default function AdminAddMarksModal({ isOpen, onClose, student }: AddMarksModalProps) {
            ...
            <div className="bg-white rounded-2xl w-[400px] p-6 shadow-xl relative animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="grid grid-cols-[100px_1fr] gap-y-3 text-sm font-semibold text-[#282828] mb-8">
                    ...
                    <span className="font-medium text-gray-600 flex items-center gap-1">
                        ...
                        <span className="max-w-[180px] overflow-x-auto whitespace-nowrap scrollbar-thin scrollbar-thumb-gray-300">
                            {student.file}
                        </span>
                    </span>
                </div>
                ...
                <div className="flex justify-center gap-3 w-full">
                    <button onClick={onClose} className="flex-1 py-2.5 cursor-pointer rounded-lg border border-[#7B7B7B] text-[#7B7B7B] font-bold text-sm">
                        Cancel
                    </button>
                    <button onClick={onClose} className="flex-1 py-2.5 cursor-pointer rounded-lg bg-[#43C17A] text-white font-bold text-sm">
                        Save
                    </button>
                </div>
            </div>
