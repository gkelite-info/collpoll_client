  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-4">
        <h2 className="text-[17px] font-bold tracking-tight truncate block" style={{ color: text }}>
          {name}
        </h2>
        <div
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-gray-700 font-semibold text-sm ml-1">+10</span>
      </div>
