...
//     mentors: [USERS[2], USERS[4], USERS[3], USERS[5]],
//     faculty: USERS[2],
...
//         } else {
//             setFormData({ title: "", president: null, vicePresident: null, faculty: null });
//             setLogoPreview(null);
//         }
//     }, [editId]);
...
//                 <div>
//                     <label className="block text-[15px] font-semibold text-gray-800 mb-2">Club Title</label>
//                     <input
//                         type="text"
//                         placeholder="Enter club title"
//                         value={formData.title}
//                         onChange={(e) => setFormData({ ...formData, title: e.target.value })}
//                         className="w-full border border-[#CCCCCC] rounded-lg px-4 py-3 text-sm font-medium text-gray-800 focus:outline-none focus:border-gray-400 transition-colors"
//                     />
//                 </div>
...
//                         <label className="text-[15px] font-semibold text-gray-800">Mentors</label>
//                         <button className="bg-[#2eb872] cursor-pointer hover:bg-[#259c60] text-white text-xs font-semibold px-3 py-1.5 rounded-full flex items-center gap-1.5 transition-colors">
...
//                         {(editId ? MOCK_CLUB_DATA.mentors : USERS.slice(2, 6)).map((mentor, i) => (
//                             <div key={i} className="border border-[#CCCCCC] rounded-lg px-3 py-2.5 flex items-center gap-3 bg-white">
//                                 <Avatar src={mentor.avatar} alt={mentor.name} size={32} />
//                                 <span className="text-sm font-semibold text-[#1a2b4c]">{mentor.name}</span>
//                             </div>
//                         ))}
//                     </div>
//                 </div>
...
//                         }}
//                     />
//                     <button className="bg-[#1a2b4c] text-white cursor-pointer rounded-lg px-4 py-3 text-[15px] font-semibold hover:bg-[#121e36] transition-colors w-full shadow-sm">
