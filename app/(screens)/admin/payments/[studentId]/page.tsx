...
import { FeePlan, FeeSummaryItem } from "../../../(student)/payments/components/academicFees";
import AdditionalDues, { ExcessDue, FinancialDue, NonFinancialDue } from "../../../(student)/payments/components/additionalDues";
import History, { Transaction } from "../../../(student)/payments/components/history";
...
export default function StudentPage() {
    ...
    const [activeTab, setActiveTab] = useState<"additional" | "history">("additional");
