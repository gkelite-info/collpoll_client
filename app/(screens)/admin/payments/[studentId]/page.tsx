...
import ProfileCard from "../../../(student)/payments/components/profileCard";
import AdditionalDues, {
  ExcessDue,
  FinancialDue,
  NonFinancialDue,
} from "../../../(student)/payments/components/additionalDues";
import History, {
  Transaction,
} from "../../../(student)/payments/components/history";
...
import {
  FeePlan,
  FeeSummaryItem,
} from "@/app/(screens)/finance/(dashboard)/[studentId]/components/academicFees";
...
export default function StudentPage() {
  ...
  const [activeTab, setActiveTab] = useState<"additional" | "history">(
    "additional",
  );
  ...
  return (
    <>
      <div className="min-h-screen p-2 bg-[#F5F5F7]">
        <div className="bg-red-00 mx-auto max-w-6xl">
            ...
            <div className="max-w-3xl">
              <div className="flex items-center gap-3">
                <ArrowBendLeftDown
                  size={26}
                  weight="fill"
                  className="text-black rotate-90 cursor-pointer active:scale-90"
                  onClick={router.back}
                />
                <h1 className="text-[#282828] font-bold text-2xl mb-1">
                  Payments - CSE 1st Year
                </h1>
              </div>
              <p className="text-[#282828] lg:text-md">
...
// import { FaChevronDown } from "react-icons/fa6";
// import ProfileCard from "../../../(student)/payments/components/profileCard";
// // 🟢 Removed the old ExcessDue, FinancialDue, NonFinancialDue imports
// import AdditionalDues from "../../../(student)/payments/components/additionalDues";
// import History, {
//   Transaction,
// } from "../../../(student)/payments/components/history";
// import { useState } from "react";
...
// // 🟢 Deleted mockNonFinancialDues, mockExcessDues, and mockFinancialDues
// // since we fetch them from the DB now!
