...
export type WellbeingManagerLeaveStatus = "approved" | "pending" | "rejected";
...
export type WellbeingManagerLeaveRequest = {
  ...
  description: string;
  attachment?: string;
  status: WellbeingManagerLeaveStatus;
  chat: LeaveChatMessage[];
};

export const leaveRequests: WellbeingManagerLeaveRequest[] = [
  {
    serialNo: "01",
