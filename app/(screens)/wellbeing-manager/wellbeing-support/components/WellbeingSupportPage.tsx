...
export default function WellbeingSupportPage() {
  ...
  return (
    <div className="bg-[#F3F3F3] p-2 sm:p-4 md:p-6 py-7 flex flex-col min-h-screen">
      <section className="mx-auto my-auto w-full rounded-xl bg-white px-4 sm:px-8 lg:px-16 py-6 sm:py-10 shadow-sm flex flex-col flex-1">

        <div className="mx-auto grid w-full max-w-3xl grid-cols-1 min-[480px]:grid-cols-2 md:grid-cols-4 gap-4 flex-shrink-0">
