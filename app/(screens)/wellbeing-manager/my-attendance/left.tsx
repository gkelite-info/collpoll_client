...
const MyAttendanceLeft = () => {
  ...
  return (
    <main className="flex items-stretch justify-between w-full pb-2 max-md:flex-col max-md:gap-4 relative">
      <div className="w-full flex-1 min-w-0 font-sans min-h-150 pt-4 px-2.5 max-md:px-0 relative">
          ...
          <div className="relative flex items-center bg-[#E5E5E5] p-1 rounded-full w-full max-w-[700px] justify-between">
            {mainTabs.map((tab) => (
              <button
                ...
                className={`relative z-10 w-1/3 py-1.5 text-[15px] max-md:text-[11px] max-md:px-1 max-md:leading-tight cursor-pointer transition-colors duration-300 ${
              ...
              <div className="flex justify-center mb-4 gap-12 max-md:gap-4 max-md:justify-around w-full">
                {payrollSubTabs.map((tab) => (
                  <button
                    ...
                    className={`text-[15px] max-md:text-[13px] cursor-pointer pb-1.5 transition-all duration-300 ${
