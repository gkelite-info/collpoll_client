      ...
      <div className="grid grid-cols-2 gap-4 w-full items-center justify-center shrink-0">
        {button ? (
          <button 
            ...
            className="flex cursor-pointer w-[95%] items-center justify-center gap-2 bg-[#43C17A] hover:bg-[#34A362] text-white py-2 -mt-1 rounded-full text-sm font-bold transition-all shadow-[0_2px_10px_rgba(67,193,122,0.25)] active:scale-95 group"
          >
