...
export type PlacementLeaveStatus = "approved" | "pending" | "rejected";
...
export type PlacementLeaveRequest = {
  ...
  description: string;
  attachment?: string;
  status: PlacementLeaveStatus;
  chat: LeaveChatMessage[];
};

export const leaveRequests: PlacementLeaveRequest[] = [
  {
    serialNo: "01",
