    ...
    `,
      ...
      <div className="w-[55%] h-screen flex justify-center items-center bg-[#F5F6F8]">
        <div className="w-[560px] bg-white rounded-[8px] shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-8">
          <h1 className="text-[20px] font-semibold text-[#16284F] text-center text-lg">
          ...
          {/* Email */}
          <div className="mt-6">
            <label className="text-[13px] text-[#16284F] font-medium text-lg">
              Email
            </label>
            <input
              type="email"
              placeholder="Enter your registered email"
              className="w-full mt-1 h-[44px] px-4 rounded-md border border-[#E6E6E6]
                   text-[14px] focus:outline-none text-black text-lg"
              value={email}
          ...
          <div className="mt-4">
            ...
            <button className="text-[13px] text-[#16284F] mt-2 w-full text-right text-lg">
              Forgot Password?
            </button>
          </div>
          ...
          <div className="w-full flex justify-between mt-8">
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className="w-[48%] h-[42px] bg-[#059C3E] text-white rounded-md text-[13px]"
            >
          ...
          <p className="text-center mt-4 text-[14px] text-[#444]">
            ...
            <Link
              href="/signup"
              className="text-[#059C3E] font-medium cursor-pointer"
            >
              Register Now
            </Link>
          </p>
