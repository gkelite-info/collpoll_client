    ...
    return (
        <>
            {subjectProps.map((item, index) => {
                ...
                return (
                    <div key={index} className="bg-white rounded-lg w-full min-h-[281px] p-4 flex flex-col justify-between shadow-md">
                        <div className="flex flex-col justify-start h-auto gap-2">
                            <div className="flex items-center justify-between gap-3">
                                ...
                                <p className="bg-[#7051E1] px-2 text-white font-medium py-1 rounded-lg text-[14.73px] cursor-pointer">
                                    View Details
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col gap-3 mt-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="h-[36px] w-[36px] rounded-full flex items-center justify-center overflow-hidden">
                                        <img src={item.profileIcon} className="h-full w-full object-cover" />
                                    </div>
                                    <p className="text-[#525252] text-[18px]">{item.lecturer}</p>
                                </div>
                                <div className="flex items-center gap-6">
                                    <h5 className="text-[#525252] text-[20px]">
                                        <strong className="text-[#282828] font-medium mr-2">Units:</strong>{item.units}
                                    </h5>
                                    <h5 className="text-[#525252] text-[20px]">
                                        <strong className="text-[#282828] font-medium mr-2">Topics Covered :</strong>{item.topicsCovered}/{item.topicsTotal}
                                    </h5>
                                </div>
                                <h5 className="text-[#525252] text-[20px]">
                                    <strong className="text-[#282828] font-medium mr-2">Next lesson :</strong>{item.nextLesson}
                                </h5>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col justify-between mt-2 relative">
                            ...
                            <div className="relative w-full h-6 mt-1">
                                <span className="absolute bg-gradient-to-b from-[#7153E1] to-[#2D1A76] bg-clip-text text-transparent font-medium transition-all duration-700 ease-out text-xs"
                            ...
                            <div className="flex items-center gap-1 mt-2">
                                ...
                                <p className="text-[13px] text-[#7153E1]">{item.fromDate} - {item.toDate}</p>
                            </div>
                        </div>
                    </div>
                )
