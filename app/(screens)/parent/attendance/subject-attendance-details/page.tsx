...
import { CaretLeft, CaretDown, Chalkboard, Percent } from "@phosphor-icons/react";
...
type StudentAttendanceDetails = Awaited<
  ReturnType<typeof getParentAttendanceDetails>
>;
...
function ParentSubjectAttendanceDetailsClient() {
  ...
  return (
    <div className="flex flex-col pb-3 max-md:pb-0">
      <div className="flex justify-between items-center">
        <div className="flex flex-col w-[50%] max-md:w-full">
          ...
          <p className="text-[#282828] max-md:text-gray-600 max-md:text-[13px]">
            {t("Track, manage, and maintain your wards attendance effortlessly")}
          </p>
        </div>
      ...
      <div className="my-2 w-[68%] max-md:w-full max-md:mt-5">
      ...
      <div className="mt-4 flex flex-col items-center max-md:p-3">
        ...
        <div className="mt-4 w-[85%] max-md:w-full max-md:mt-3 max-md:overflow-x-auto scrollbar-hide">
          {/* DESKTOP VIEW */}
          <div className="hidden md:block max-md:min-w-100">
            <TableComponent
              columns={columns}
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <StatusBadge status={normalizeStatus(row.rawStatus)} />
                      <div
