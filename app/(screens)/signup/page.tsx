...
export default function Signup() {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      if (!emailRegex.test(formData.email))
        return toast.error("Email must be lowercase only!");
  ...
  `}
    ...
    `,
      ...
      {/* RIGHT SECTION - FORM SIDE (Ultra Compact + Updated Labels & Placeholders) */}
      <div className="w-[700px] h-screen bg-[#EEEEEE] px-6 py-4 overflow-y-auto relative z-20 flex items-center justify-center">
